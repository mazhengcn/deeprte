...
def _weight_decay_exclude(
    ...
    Args:
      exclude_names: an optional list of names to include for weight_decay.
        ['w'] by default.
...
def add_weight_decay(
    ...
    Args:
      ...
      exclude_names: an optional list of names to exclude for weight_decay.
        ['b'] by default.
...
def make_optimizer(optimizer_config, lr_schedule):
    ...
    if (
        optimizer_config.get("decay_pos_embs") is None
        or optimizer_config.decay_pos_embs
    ):
