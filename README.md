...
First we need to copy datasets to our `/path/to/project_root` folder. Currently the downloaded datasets are MATLAB `.mat` files. You can do this by running the following script:
